function psallON(obj, varargin)
    ...
    optargs = {200 1 15 0.083 12 inf 10 1 1};
    % overwrite defaults with values specified in varargin
    numvarargs = length(varargin);
    optargs(1:numvarargs) = varargin;
    % place optional args in memorable variable names
    [MinPeakHeight, LightDur, LightOnsetTime, MinPeakDistance, ymaxhist, ymax, NumPeaksBeforeAfter, DelayScaleFactor, LightExtensionFactor] = optargs{:};
