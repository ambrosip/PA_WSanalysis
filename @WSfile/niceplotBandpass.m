...
% optional arguments: axis range for channel 1 (monitor CC or VC)
    ...
    optargs = {100 2000 -100 100 15 3 10 23};
    optargs(1:numvarargs) = varargin;
    [highpassThreshold, lowpassThreshold, ymin, ymax, lightOnsetTime, lightDuration, xmin, xmax] = optargs{:};
...
%         plot(x,yFiltered,'k','LineWidth',1);
        plot(x,yFiltered,'Color', [77/255 172/255 38/255], 'LineWidth',1);
