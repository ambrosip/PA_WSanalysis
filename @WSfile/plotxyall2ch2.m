function plotxyall2ch2(obj, varargin)

    % plots TWO channels and all sweeps combined in single figure and in
    % separate figures per sweep.

    % EX: plotxyall2ch2(m293.s0061);
    % EX: plotxyall2ch2(m293.s0061,-inf,inf,-1000,500);    
