function psallch(obj, varargin)
    ...
    optargs = {45 1 0 15 10 0.005 1 1};
    % overwrite defaults with values specified in varargin
    numvarargs = length(varargin);
    optargs(1:numvarargs) = varargin;
    % place optional args in memorable variable names
    [ymax, LightDur, MinPeakHeight, LightOnsetTime, NumPeaksBeforeAfter, MinPeakDistance, DelayScaleFactor, LightExtensionFactor] = optargs{:};
