...
heatmapMin = -2;
heatmapMax = 0;
cellImageFileNameDIC = 's2c1_z1_dic.tif';
cellImageFileNameAlexa = 's2c1_z1_dic.tif';
...
figure('name', strcat(fileName, '_', analysisDate, ' - firing_vs_light_polygon - DIC image grid'));
hold on;
...
figure('name', strcat(fileName, '_', analysisDate, ' - firing_vs_light_polygon - Alexa image grid'));
hold on;
imshow(croppedImage, 'Border', 'tight');
