...
%     optargs = {0 2 2500 0 30 -250 -250 50 0.1 'D:\CORONAVIRUS DATA\From MATLAB'}; % for OLD data
    optargs = {0 2 2500 5 25 -500 -500 50 1 'D:\CORONAVIRUS DATA\From MATLAB'}; 
...
%     optargs = {1 2 1000 0 30 -300 -200 100 1 'D:\Temp\From MATLAB 2020'};
    ...
    rsBaselineDataPointInterval = ((rsTestPulseOnsetTime-0.005)*sampleRate):(rsTestPulseOnsetTime*sampleRate); % for OLD data
%     rsBaselineDataPointInterval = ((rsTestPulseOnsetTime-0.01)*sampleRate):(rsTestPulseOnsetTime*sampleRate);
