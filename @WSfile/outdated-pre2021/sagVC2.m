function [dataDisplay, dataPerSweepCh1, dataPerSweepCh2] = sagVC2(obj,varargin)
...
%         sagPeak = min(ysubset);
        ...
        data = [data; mouseNumber, experimentDate, sweepNumber, sagRatio, sagCurrent, leakCurrent, baselineCurrent, sagPeak];
        dataPerSweepCh1 = [dataPerSweepCh1, x, y];
        dataPerSweepCh2 = [dataPerSweepCh2, xch2, ych2];
    end    
    
    dataDisplay = data(:,3:end);
...
%     xlabel('Time (s)')
    ...
    % save csv file with data 
        ...
        labeledData = cell2table(dataInCellFormat,'VariableNames',{'mouse', 'date', 'sweepNumber', 'sagRatio', 'sagCurrent', 'leakCurrent', 'baselineCurrent', 'sagPeak'});
