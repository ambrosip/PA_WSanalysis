function gbzEffectHzSD(cohort, notconnected_data, connected_data)
...
figure('name', strcat("gbzEffectHzSD_", analysisDate, "_", cohort), 'Units', 'points');
hold on;
...
ylabel('SDs from baseline Hz');
yticks([-16:2:2])
yticklabels({'-16','','','','','','','-2','0','2'});
xticklabels({'-GBZ','+GBZ'});
