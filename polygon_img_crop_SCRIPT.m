...
cellImageFile = 's3c1_40_1_647_4';
cellImageDir = '/Users/priscilla/OHSU Dropbox/Priscilla Ambrosi/Dropbox - Lerner Lab/Ambrosi et al_sCRACM 2024/Raw data - main/DMS/m036/s3c1';

leftCrop = 0;     % old: 0    old (2022-12-25): 0     new (2023-08-20): 0    % in pixels        % ALERT! this is new (2023-08-20)   
rightCrop = 8;    % old: 0    old (2022-12-25): 14    new (2023-08-20): 8    % in pixels        % ALERT! this is new (2023-08-20)
topCrop = 69;     % old: 100  old (2022-12-25): 106   new (2023-08-20): 69   % in pixels        % ALERT! this is new (2023-08-20)
bottomCrop = 88;  % old: 51   old (2022-12-25): 58    new (2023-08-20): 88   % in pixels        % ALERT! this is new (2023-08-20)
...
fig1 = figure('name', strcat(fileName, cellImageFileName, '_cropped_on_', analysisDate, ' - image grid'));
ax1 = axes(fig1);
hold on;
...
%
fig2 = figure('name', strcat(fileName, cellImageFileName, '_cropped_on_', analysisDate, ' - inverted grid'));
ax2 = axes(fig2);
hold on;
imshow(croppedImage, 'Border', 'tight');
